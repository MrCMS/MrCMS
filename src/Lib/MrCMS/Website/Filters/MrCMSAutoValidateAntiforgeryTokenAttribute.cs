...
public class MrCMSAutoValidateAntiforgeryTokenAttribute : Attribute, IFilterFactory, IOrderedFilter
{
    /// <summary>
    ...
    {
        return serviceProvider.GetRequiredService<MrCMSAutoValidateAntiforgeryTokenAuthorizationFilter>();
    }
}