        ...
        public static void Initialize(string connectionString)
        {
            var upgrader =
                DeployChanges.To
                    ...
                    .WithScript(new SqlScript("0000 - Quartz Tables", AddQuartzTables))
                    .LogToConsole()
            ...
            if (!result.Successful)
                throw new Exception("An error occurred running the update scripts", result.Error);
        }

        private const string AddQuartzTables =
