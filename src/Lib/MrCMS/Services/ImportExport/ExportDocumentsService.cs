...
namespace MrCMS.Services.ImportExport
{
    public class ExportDocumentsService : IExportDocumentsService
    {
        ...
        private static void CreateInfoSheet(ExcelPackage excelFile)
        {
            ...
            var assemblyVersion = typeof(ExportDocumentsService).Assembly.GetCustomAttribute<AssemblyVersionAttribute>()
                ?.Version;
            ...
            wsInfo.Cells["D2"].Value = string.Format("MrCMS {0}", assemblyVersion);
        ...
        private static void AddWebpage(List<Webpage> webpages, int index, ExcelWorksheet wsItems)
        {
            ...
            wsItems.Cells["C" + rowId].Value = webpage.DocumentClrType;
