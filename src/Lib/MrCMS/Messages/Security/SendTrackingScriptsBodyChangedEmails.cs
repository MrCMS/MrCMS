...
namespace MrCMS.Messages.Security
{
    public class SendTrackingScriptsBodyChangedEmails : IOnTrackingScriptsBodyChanged
    {
        ...
        public SendTrackingScriptsBodyChangedEmails(ISystemConfigurationProvider configurationProvider, IMessageParser<TrackingScriptsBodyChangeMessageTemplate, SettingScriptChangeModel> parser)
        {
