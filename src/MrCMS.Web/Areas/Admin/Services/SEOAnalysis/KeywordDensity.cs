...
namespace MrCMS.Web.Areas.Admin.Services.SEOAnalysis
{
    public class KeywordDensity : BaseSEOAnalysisFacetProvider
    {
            ...
            string analysisTerm)
        {
            ...
            {
                yield return
                    await GetFacet("Keyword density", SEOAnalysisStatus.Error, "There is not enough content to calculate keyword density.");
            }
            ...
            {
                yield return
                    await GetFacet("Keyword density", SEOAnalysisStatus.Error,
            ...
            {
                yield return
                    await GetFacet("Keyword density", SEOAnalysisStatus.Success,
