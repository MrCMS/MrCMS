...
namespace MrCMS.Web.Tests.Areas.Admin.Services
{
    public class LayoutAreaAdminServiceTests 
    {
        ...
        public void LayoutAreaAdminService_DeleteArea_DeletesThePassedArea()
        {
            ...
            _layoutAreaRepository.Query().Count().Should().Be(0);
        }
        ...
        [Fact]
        public void LayoutAreaAdminService_Add_IfLayoutIsSetAddLayoutAreaToLayoutAreasList()
        {
            var layout = new Layout();
            var layoutArea = new LayoutArea {Layout = layout};
        ...
        [Fact]
        public void LayoutAreaAdminService_Add_SavesTheArea()
        {
            var layoutArea = new LayoutArea();

            _layoutAreaAdminService.Add(layoutArea);

            _layoutAreaRepository.Query().Count().Should().Be(1);
        }
