...
CKEDITOR.dialog.add('paste', function(a) {
    ...
    return {
        ...
        contents: [{
            ...
            elements: [{ type: 'html', id: 'securityMsg', html: '<div style="white-space:normal;width:340px;">' + b.securityMsg + '</div>' }, { type: 'html', id: 'pasteMsg', html: '<div style="white-space:normal;width:340px;">' + b.pasteMsg + '</div>' }, {
                type: 'html',
                id: 'editing_area',
                ...
                setup: function() {
                    ...
                    if (CKEDITOR.env.ie) {
                        ...
                        j.on('focus', function() { h.$.contentWindow.focus(); });
                        i.append(j);
                        this.focus = function() {
                            j.focus();
                            this.fire('focus');
                    ...
                    this.getInputElement = function() { return h; };
                    if (CKEDITOR.env.ie) {
                ...
                commit: function(e) {
                    ...
                    i && i.remove();
                    j = h.getHtml();
                    setTimeout(function() { g.fire('paste', { html: j }); }, 0);
                }
            }]
        }]
    };
