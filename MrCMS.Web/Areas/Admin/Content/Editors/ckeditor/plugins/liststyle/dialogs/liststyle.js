...
(function() {
    ...
    ;
    var b = function(e) { return e.type == CKEDITOR.NODE_ELEMENT && e.is('li'); }, c = { a: 'lower-alpha', A: 'upper-alpha', i: 'lower-roman', I: 'upper-roman', 1: 'decimal', disc: 'disc', circle: 'circle', square: 'square' };

    function d(e, f) {
        var g = e.lang.list;
        if (f == 'bulletedListStyle')
            return {
                title: g.bulletedTitle, minWidth: 300, minHeight: 50,
                contents: [{
                    id: 'info', accessKey: 'I',
                    elements: [{
                        type: 'select', label: g.type, id: 'type', align: 'center', style: 'width:150px', items: [[g.notset, ''], [g.circle, 'circle'], [g.disc, 'disc'], [g.square, 'square']],
                        setup: function(i) {
                    ...
                    elements: [{
                        ...
                        children: [{
                                ...
                                commit: function(i) {
                                    ...
                                    if (isNaN(l)) i.removeAttribute('start');
                                    else i.setAttribute('start', l);
