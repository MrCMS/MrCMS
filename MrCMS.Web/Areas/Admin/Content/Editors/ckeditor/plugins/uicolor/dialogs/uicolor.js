...
CKEDITOR.dialog.add('uicolor', function(a) {
    ...
    ;
    d = {
        id: 'yuiColorPicker', type: 'html', html: "<div id='" + f + "' class='cke_uicolor_picker' style='width: 360px; height: 200px; position: relative;'></div>",
        onLoad: function(j) {
    ...
    return {
        ...
        contents: [{
            ...
            elements: [d, {
                ...
                type: 'vbox',
                children: [{
                        id: 'livePeview', type: 'checkbox', label: a.lang.uicolor.preview, 'default': 1, onLoad: function() { i = true; },
                        onChange: function() {
                            if (i) return;
