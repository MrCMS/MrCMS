...
(function() {
    ...
    function c(k) { return CKEDITOR.env.ie ? k.$.clientWidth : parseInt(k.getComputedStyle('width'), 10); }
    ...
    function d(k, l) {
        ...
        if (m.indexOf('px') < 0)
            if (m in n && k.getComputedStyle('border-style') != 'none') m = n[m];
            else m = 0;
    ...
    function h(k) { (k.data || k).preventDefault(); }
    ...
    function i(k) {
        ...
        function x() {
            ...
            q && y();
            var D = l.table;
            setTimeout(function() { D.removeCustomData('_cke_table_pillars'); }, 0);
