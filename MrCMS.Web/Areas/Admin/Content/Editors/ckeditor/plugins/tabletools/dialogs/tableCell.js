...
CKEDITOR.dialog.add('cellProperties', function(a) {
    ...
    function k(l, m) {
        ...
        a.execCommand(l);
        if (a._.storedDialogs.colordialog) q(a._.storedDialogs.colordialog);
        else
        ...
        contents: [{
            ...
            elements: [{
                ...
                children: [{
                        ...
                        children: [{
                                ...
                                children: [{
                                        ...
                                        commit: function(l) {
                                            ...
                                            if (!isNaN(m)) l.setStyle('width', m + n);
                                            else l.removeStyle('width');
                                            l.removeAttribute('width');
                                        },
                                        'default': ''
                                    }, {
                                        type: 'select', id: 'widthType', label: a.lang.table.widthUnit, labelStyle: 'visibility:hidden', 'default': 'px', items: [[b.widthPx, 'px'], [b.widthPc, '%']],
                                        setup: function(l) {
                                ...
                                type: 'select', id: 'wordWrap', label: c.wordWrap, 'default': 'yes', items: [[c.yes, 'yes'], [c.no, 'no']],
                                setup: function(l) {
                                    var m = l.getAttribute('noWrap'), n = l.getStyle('white-space');
                                    if (n == 'nowrap' || m) this.setValue('no');
                                },
                                commit: function(l) {
                                    if (this.getValue() == 'no') l.setStyle('white-space', 'nowrap');
                                    else l.removeStyle('white-space');
                                    l.removeAttribute('noWrap');
                                }
                            }, i, {
                                type: 'select', id: 'hAlign', label: c.hAlign, 'default': '', items: [[d.notSet, ''], [d.alignLeft, 'left'], [d.alignCenter, 'center'], [d.alignRight, 'right']],
                                setup: function(l) {
                                ...
                                type: 'select', id: 'vAlign', label: c.vAlign, 'default': '', items: [[d.notSet, ''], [d.alignTop, 'top'], [d.alignMiddle, 'middle'], [d.alignBottom, 'bottom'], [c.alignBaseline, 'baseline']],
                                setup: function(l) {
                        ...
                        type: 'vbox',
                        padding: 0,
                        children: [{ type: 'select', id: 'cellType', label: c.cellType, 'default': 'td', items: [[c.data, 'td'], [c.header, 'th']], setup: function(l) { this.setValue(l.getName()); }, commit: function(l) { l.renameNode(this.getValue()); } }, i, {
                                ...
                                children: [{
                                        ...
                                        type: 'button', id: 'borderColorChoose', 'class': 'colorChooser', label: c.chooseColor, style: (j ? 'margin-right' : 'margin-left') + ': 10px', onLoad: function() { this.getElement().getParent().setStyle('vertical-align', 'bottom'); },
                                        onClick: function() {
                                            var l = this;
