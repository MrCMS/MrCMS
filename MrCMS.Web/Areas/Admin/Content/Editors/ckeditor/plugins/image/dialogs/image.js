    ...
    var r = function (c, j) {
        ...
        var f = 1, k = /^\s*(\d+)((px)|\%)?\s*$/i, v = /(^\s*(\d+)((px)|\%)?\s*$)|^$/i, o = /^\d+px$/,
            w = function () {
                ...
                CKEDITOR.document.getById(m).setStyle("display", "none");
                l(this, !1);
            }, n = function (a) { return CKEDITOR.tools.getNextId() + "_" + a; }, p = n("btnLockSizes"), u = n("btnResetSize"), m = n("ImagePreviewLoader"), A = n("previewLink"),
            z = n("previewImage");
        return {
            ...
            contents: [{
                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            commit: function (a, b) { a == f && (this.getValue() || this.isChanged()) ? (b.data("cke-saved-src", this.getValue()), b.setAttribute("src", this.getValue())) : 8 == a && (b.setAttribute("src", ""), b.removeAttribute("src")); },
                ...
                elements: [{
                    type: "hbox",
                    widths: ["50%", "25%", "25%"],
                    children: [{ type: "text", id: "linkId", label: c.lang.common.id, setup: function (a, b) { a == f && this.setValue(b.getAttribute("id")); }, commit: function (a, b) { a == f && (this.getValue() || this.isChanged()) && b.setAttribute("id", this.getValue()); } }, {
                        id: "cmbLangDir",
                        type: "select",
                        style: "width : 100px;",
                    ...
                    }, { type: "text", id: "txtLangCode", label: c.lang.common.langCode, "default": "", setup: function (a, b) { a == f && this.setValue(b.getAttribute("lang")); }, commit: function (a, b) { a == f && (this.getValue() || this.isChanged()) && b.setAttribute("lang", this.getValue()); } }]
                }, {
                    type: "text",
                    id: "txtGenLongDescr",
                    ...
                    type: "hbox",
                    widths: ["50%", "50%"],
                    children: [{ type: "text", id: "txtGenClass", label: c.lang.common.cssClass, "default": "", setup: function (a, b) { a == f && this.setValue(b.getAttribute("class")); }, commit: function (a, b) { a == f && (this.getValue() || this.isChanged()) && b.setAttribute("class", this.getValue()); } }, {
                        type: "text",
                        id: "txtGenTitle",
