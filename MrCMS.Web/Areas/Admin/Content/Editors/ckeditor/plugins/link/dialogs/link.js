            ...
            elements: [{ id: 'linkType', type: 'select', label: E.type, 'default': 'url', items: [[E.toUrl, 'url'], [E.toAnchor, 'anchor'], [E.toEmail, 'email']], onChange: d, setup: function (F) { if (F.type) this.setValue(F.type); }, commit: function (F) { F.type = this.getValue(); } }, {
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        onLoad: function () {
                            this.getInputElement().addClass('file-url-protocol');
                        },
                        setup: function (F) { if (F.url) this.setValue(F.url.protocol || ''); },
                        commit: function (F) {
                            if (!F.url) F.url = {};
                        ...
                        onLoad: function () {
                            this.getInputElement().addClass('file-url');
                        },
                        commit: function (F) {
                            this.onChange();
                            if (!F.url) F.url = {};
                ...
                children: [{
                    ...
                    type: 'html', id: 'noAnchors', style: 'text-align: center;', html: '<div role="label" tabIndex="-1">' + CKEDITOR.tools.htmlEncode(E.noAnchors) + '</div>', focus: true,
                    setup: function (F) {
