...
CKEDITOR.dialog.add('scaytcheck', function(a) {
    ...
    var s = function() {
        ...
        if (f[1] == 1) {
            ...
            D.sort(function(U, V) { return V.lang > U.lang ? -1 : 1; });
        ...
        if (f[0] == 1) {
            ...
            for (var B = 0, C = A.length; B < C; B++) {
                ...
                if (E) {
                    ...
                    if (b) E.on('click', function() { z.options[this.getId().split('_')[0]] = this.$.checked ? 1 : 0; });
                }
            }
        }
        if (f[1] == 1) {
        ...
        if (i) {
            ...
            }, function() { d.getById('dic_name_' + e).setValue(''); });
            v('');
        }
    };

    function u(z) { d.getById('dic_message_' + e).setHtml('<span style="color:red;">' + z + '</span>'); }

    ;

    function v(z) { d.getById('dic_message_' + e).setHtml('<span style="color:blue;">' + z + '</span>'); }
    ...
    function y(z) { d.getById('dic_name_' + e).$.value = z; }
