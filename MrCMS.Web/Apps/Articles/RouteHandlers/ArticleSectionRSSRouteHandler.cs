...
{
    public class ArticleSectionRSSRouteHandler : IMrCMSRouteHandler
    {
        private readonly IControllerManager _controllerManager;
        private readonly IDocumentService _documentService;

        public ArticleSectionRSSRouteHandler(IDocumentService documentService, IControllerManager controllerManager)
        {
